    ...
    render() {
        return (
            <form onSubmit={this.formSubmit} className="form">
                Form title
                <input required  className="form__input" placeholder="First name" type="text" name="firstName"/>
                <input  required className="form__input" placeholder="Last name" type="text" name="lastName" />
                <input required  className="form__input" placeholder="Email address" type="email" name="email" />
